...
import code.cameo.placeautocomplete.SlideUp.enums.Duration;
...
interface IBuilder {
     ...
     * @return this
     * @see code.cameo.placeautocomplete.SlideUp.enums.Style
     */
     ...
     * @param withAnimation true to enable animation, false otherwise
     * @return this
     * @see code.cameo.placeautocomplete.SlideUp.enums.Duration
     */
